...
.text
	...
	move_up:
		...
		sub $t1, $t1, 68	#128+4, estos 4 extra es la nueva pos del usuario
		li $t5, 0x00FF00		#va a ser verde
		jal dibujar_recta_horizontal
...
#las funciones de move se basan en dicha posicion para la suma y resta de posiciones
	...
	move_left:
		...
		li $t5, 0x00FF00		#va a ser verde
		jal dibujar_recta_vertical
		#TODO: MUY PROBABLEMENTE LA DIRECCION DE MEMORIA DE JUGADOR_X SEA DONDE ESTA GUARDADO $T6
		#ESTO EXPLICARIA PORQUE AL RESTAR 4 EN X TAMBIEN SE RESTA 4 EN Y
		#UNA POSIBLE SOLUCION SERIA GUARDAR EL VALOR DE $T6 EN OTRO LUGAR
		lw $t0, 0($s0)
		sub $t0, $t0, 4
		sw $t0, 0($s0)
		j gameplay
